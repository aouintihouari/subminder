...
// ✅ 1. Mocker Redis pour empêcher la vraie connexion qui bloque Jest
jest.mock("../../shared/lib/redis");

jest.mock("../../shared/lib/prisma");

// ✅ 2. Correction du chemin vers email.service (ajout de 'shared')
...
describe("POST /api/v1/auth/forgot-password", () => {
  ...
  it("should send reset email for existing user", async () => {
    ...
    // ✅ 3. Correction du chemin dans le require
    const emailService =
      require("../../shared/services/email.service").emailService;
  ...
  it("should handle email service failures gracefully", async () => {
    ...
    // ✅ 4. Correction du chemin dans le require
    const emailService =
      require("../../shared/services/email.service").emailService;
    emailService.sendPasswordResetEmail = jest
      .fn()
