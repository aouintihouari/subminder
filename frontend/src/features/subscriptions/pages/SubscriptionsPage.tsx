...
// UserNav will be moved to the Layout later, but we keep it here for now to not break the UI
...
export function SubscriptionsPage() {
  ...
  return (
    <div className="dark:bg-background min-h-screen bg-gray-50 transition-colors duration-300">
      {/* TODO: This Header will eventually be removed when we implement the App Shell Sidebar.
         We keep it for this step to ensure the page renders exactly as before.
      */}
